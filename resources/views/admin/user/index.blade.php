                ...
                <div class="card">
                    ...
                    <div class="card-body" v-cloak>
                        ...
                        <div class="row" v-if="pagination.state.total > 0">
                            <div class="col-sm">
                                <span class="pagination-caption">Displaying items from @{{ pagination.state.from }} to @{{ pagination.state.to }} of total @{{ pagination.state.total }} items.</span>
                            </div>
                        </div>
	                    ...
	                    <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin.users.create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;New User</a>
	                    </div>
                    </div>
                </div>
            </div>
