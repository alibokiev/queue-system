            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Категории
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/categories/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; Добавить</a>
                    </div>
                    <div class="card-body" v-cloak>
                            ...
                            <div class="row justify-content-md-between">
                                <div class="col col-lg-7 col-xl-5 form-group">
                                    <div class="input-group">
                                        <input class="form-control" placeholder="Поиск" v-model="search" @keyup.enter="filter('search', $event.target.value)" />
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'color'">{{ trans('admin.category.columns.color') }}</th>
	                    ...
	                    <div class="no-items-found" v-if="!collection.length > 0">
		                    ...
		                    <p>измените запрос поиска</p>
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/categories/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; Добавить</a>
	                    </div>
                    </div>
                </div>
            </div>
